...
@ContextConfiguration("/com/decisionem/google/app.xml")
...
public class SearchServiceTest {
	...
	public void testSearch() throws SearchException {
		List<SearchResult> results = googleSearchService.search("Michael Jackson");

		for (SearchResult result : results) {
			assertNotNull(result.getTitle());
			assertNotNull(result.getUrl());
			logger.info("Google: " + result.getTitle() + " / " + result.getDescription() + " / " + result.getUrl());
		}
	}
